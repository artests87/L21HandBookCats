...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createAndInitilListViewMain(getStringFromStrings());
    ...
    private String[] getStringFromStrings(){
        return getResources().getStringArray(R.array.HandBookCats);
    }
    private void createAndInitilListViewMain(String[] stringArray){
        mListViewMain=(ListView)findViewById(R.id.listView);
